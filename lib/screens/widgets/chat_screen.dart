...
class _UserChatScreenState extends State<UserChatScreen> {
  ...
  void _connectSocket() {
    ...
    socket.onConnect((_) {
      ...
      print('Connected to socket & joined: $chatId');
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFEF9FC), // light background
      appBar: AppBar(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                final isMe = msg['senderId'] == widget.userId || msg['sender_id'] == widget.userId;
